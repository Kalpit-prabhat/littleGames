...
exit = pygame.image.load(r'data\exit_btn.png').convert_alpha

window.blit(single_player , (400 ,400 ))
...
while True:
    ...
    text1 = game_font.render(f"{player1_score}", False, light_grey)
    text2 = game_font.render(f"{player2_score}", False, light_grey)
